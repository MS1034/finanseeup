...
TransactionModel _$TransactionModelFromJsonLocally(Map<String, dynamic> json) =>
    TransactionModel(
      accountId: json['accountId'] as String,
      category: json['category'] as String?,
      amount: (json['amount'] as num).toDouble(),
      paymentType: json['paymentType'] as String?,
      description: json['description'] as String?,
      labels: (json['labels'] as String).split(",").toList(),
      payee: json['payee'] as String?,
      dateTime: json['dateTime'] == null
          ? null
          : DateTime.parse(json['dateTime'] as String),
...
Map<String, dynamic> _$TransactionModelToJsonLocally(
  ...
  writeNotNull('accountIdTo', instance.accountIdTo);
  val['description'] = instance.description;
  writeNotNull('labels', instance.labels!.join(","));
  writeNotNull('payee', instance.payee);
  writeNotNull('dateTime', instance.dateTime?.toIso8601String());
  writeNotNull('paymentType', instance.paymentType);
  writeNotNull('receiptImage', instance.receiptImage);
